...
function VirtualStore() {
  ...
  return (
    <div className="relative overflow-hidden px-4 sm:px-8">
      ...
      <div className="mt-[20px] flex flex-col items-center sm:flex sm:flex-row justify-center ">
        <svg
        ...
        <div className="flex flex-col items-center sm:absolute sm:right-[5%] sm:bottom-[10px]">
